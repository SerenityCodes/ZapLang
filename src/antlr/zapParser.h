...
public:
  ...
  enum {
    ...
    RuleDeferStmt = 24, RuleExpressionStmt = 25, RuleExpression = 26, RuleLvalue = 27, 
    RuleAssignment = 28, RuleLogicOr = 29, RuleLogicAnd = 30, RuleEquality = 31, 
    RuleComparison = 32, RuleTerm = 33, RuleFactor = 34, RuleUnary = 35, 
    RuleCall = 36, RuleArgumentList = 37, RulePrimary = 38, RuleAotBlock = 39
  };
