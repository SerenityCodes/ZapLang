...
class zapVisitor : public antlr4::tree::AbstractParseTreeVisitor {
   ...
   */
    ...
    virtual std::any visitStructField(
        zapParser::StructFieldContext *context) = 0;

    virtual std::any visitComponentDecl(
        zapParser::ComponentDeclContext *context)                           = 0;
    ...
    virtual std::any visitVariableDecl(
        zapParser::VariableDeclContext *context)                            = 0;
    ...
    virtual std::any visitExpressionStmt(
        zapParser::ExpressionStmtContext *context)                          = 0;
    ...
    virtual std::any visitArgumentList(
        zapParser::ArgumentListContext *context)                        = 0;
