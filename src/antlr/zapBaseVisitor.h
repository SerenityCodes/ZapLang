...
public:
  ...
  virtual std::any visitFunctionDecl(zapParser::FunctionDeclContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAttributeBlock(zapParser::AttributeBlockContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitReturnType(zapParser::ReturnTypeContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitParameterList(zapParser::ParameterListContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitStructDecl(zapParser::StructDeclContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitStructField(zapParser::StructFieldContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitComponentDecl(zapParser::ComponentDeclContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitModuleDecl(zapParser::ModuleDeclContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitVariableDecl(zapParser::VariableDeclContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitReturnStmt(zapParser::ReturnStmtContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitExpressionStmt(zapParser::ExpressionStmtContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitExpression(zapParser::ExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitAssignment(zapParser::AssignmentContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitComparison(zapParser::ComparisonContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitArgumentList(zapParser::ArgumentListContext *ctx) override {
    return visitChildren(ctx);
  }
